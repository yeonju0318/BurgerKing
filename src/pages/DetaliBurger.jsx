...
function DetaliBurger() {
  ...
  // 카테고리
  const [category, setCategory] = useState("스페셜&할인팩");
  ...
  return (
    <>
      ...
      <StDetailContent>
        ...
        <StFlex>
          <StAddImg src={burger?.imageUrl}></StAddImg>
          <StAddInputForms>
            {updateModalOpen ? (
              ""
            ) : (
            ...
            {updateModalOpen && (
              <>
                ...
                <>
                  <StChangeButton type="button" onClick={openCategory}>
                    변경할 카테고리 선택
                    <br /> {category}
                  </StChangeButton>
                  {openDropdown && (
                        ...
                        {updateModalOpen && (
                            <>
                                ...
                                <form
                                    ...
                                    <StChangeButton onClick={updateButtonHandler}>수정하기</StChangeButton>
                                </form>
                            </>
                        )}
...
const StButton = styled.button`
  border: 2px solid rgb(226, 141, 141);
  border-radius: 8px;
  width: 100px;
  font-weight: 800;
`;
...
`;
const StChangeButton = styled.button`
...
const StChangeButtonDropDown = styled.button`
  border: 2px solid rgb(226, 141, 141);
  margin: 5px;
  padding: 5px 10px;
  font-size: 14px;
