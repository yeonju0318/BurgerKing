...
function Store() {
  ...
  const filterStore = store?.filter(
    (item) => item.category_group_name !== "주차장"
  );
          ...
          <StSearchBar>
            ...
            <StSearch>
              <div onClick={siDropdown}>
                <StCategory>{selectedSi}</StCategory>
                <StdropdownLists>
                  {siOpen &&
                    searchSi.map((item) => {
                      return (
              ...
              <div onClick={guDropdown}>
                <StCategory>{selectedGu}</StCategory>
                <StdropdownLists>
                  {guOpen &&
