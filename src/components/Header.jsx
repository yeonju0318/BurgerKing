      ...
      {addModalOpen && (
        <ModalOverlay onClick={showAddModal}>
          <ModalContent onClick={(e) => e.stopPropagation()}>
            ...
            <ModalButton>
              <button onClick={showAddModal}>취소</button>
              <button
                onClick={() => {
                  addHandler();
                }}
            ...
            >
              <div>
                <StAddImg>
                  이미지
                  <input type="file" onChange={handleFileInput} enc />
                </StAddImg>
              </div>
                  ...
                  <div>
                    ...
                    {categoryOpen && (
                      <DropdownList>
                        ...
                        <Stbutton123
                          onClick={() => itemClickHandler("치킨&슈림프버거")}
                        >
                          치킨&슈림프버거
                        </Stbutton123>
                        <Stbutton123
                          onClick={() => itemClickHandler("올데이킹&킹모닝")}
                        >
                          올데이킹&킹모닝
                        </Stbutton123>
